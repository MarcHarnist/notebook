...
//	Website owner and webmaster constants
	...
	define('WEBSITE_NAME', "Notebook");//WEBSITE_NAME = constant
	define('WEBSITE_OWNER', "Marc L. Harnist");
...
//  URL
	//  Website URL
		...
		define('DB_PASSWORD', $db_password);
			// Database table
			define('TABLE_MEMBER', 'notebook_members');
...
// Realpaths
	...
	// 	Other repertorys realpaths defined here
		...
		define('CSS', ROOT . 'css/');
		define('SQL', ROOT . 'sql/');
		define('IMG', ROOT . 'img/');//image uploader in __page-edition.php

...
class Alpha{
    ...
    const OWNER_MAIL = "marcharnistpro@gmail.com"; // Pour formulaire contact
    ...
    const NAME = "Notebook"; // Nom du site pour header: root/inc/header.php
    const DOMAIN = "notebook"; // Nom de domaine pour __explorer.php
    const SUBTITLE = "Le blog de Marc"; // Sous-titre
    ...
    const TABLE_PAGES  = 'notebook_pages';

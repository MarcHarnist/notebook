...
<h2>Chèques à la BNP (Isa)</h2>

<!--
################## MENU DU BUDGET INCLU ICI DEPUIS LE REPERTOIRE "inc" ############### -->
...
<table class="table table-striped">
  ...
  foreach($liste as $donnee){
    ...
    <tr id="<?php $ancre=$count; echo $ancre; $count++;?>">
      <form method="post" action="<?=$website->page_url;?>budget-cheques-update">
        <td>
        ...
        <td class="center">
          <form method="post" action="<?=$website->page_url;?>budget-cheques-delete">
